...
@app.route('/api/semar/dht22', methods=['POST'])
def send_dht22():
    # Read DHT22 sensor
    try:
        dhtDevice = adafruit_dht.DHT22(board.D13, use_pulseio=False)
        ...
        # Send payload to Semar
        res = requests.post(
            url,
            json=payload,
            headers={
                "Content-Type": "application/json",
                "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c3JfaWQiOiI2NzdlMTU1NTlhYTU1NzFmM2NmYmM0MWIiLCJ1c2VybmFtZSI6ImFkbWluIiwiZGV2X2lkIjoiNjg3MTQ5MjVmZGRmZTQ0NjI1M2I4NjQzIiwiZGV2X2NvZGUiOiJnc2lmOHQiLCJleHAiOjE3NTIyOTc5NTd9.cr8hS61QXRYYjrjFB-vObwExkrkmxN76ERgQ-jyspXg"  # Replace with actual token
            }
        )
...
@app.route('/api/semar/ds18b20', methods=['POST'])
def send_ds18b20():
...
@app.route('/api/semar/water', methods=['POST'])
